...
import pl.strefakursow.eLunchApp1.listeners.OperationEvidenceListeners;
import pl.strefakursow.eLunchApp1.model.*;
import pl.strefakursow.eLunchApp1.model.enums.*;
...
class OrderControllerTest {
    ...
    public static class Config {
        ...
        public OrderService orderService(OrderRepo orderRepo,
            ...
            return new OrderServiceImpl(orderRepo, userRepo, restaurantRepo, delivererRepo,deliveryAddressRepo, menuItemRepo,
                    discountCodeRepo, orderItemRepo, orderItemService);
        }
    ...
    private static final String STR_UUID = "19de5235-1d94-4d13-9f32-039689673c80";
    ...
    public void setIsGivedOut2() {
        ...
        OrderStatusDTO orderStatusJson =
                TestUtils.orderStatusDTO("2020-01-01T15:00:00Z", true, "2020-01-01T15:30:00Z", null);
        Assertions.assertThrows(ResponseStatusException.class, () -> orderController.patchIsGivedOut(UUID.fromString(STR_UUID), orderStatusJson));
    }
